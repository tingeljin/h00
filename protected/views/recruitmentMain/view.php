...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		'recruitment_id',
		'recruitment_name',
		array('name'=>'age','value'=>CHtml::encode($model->configAge->setting_name)),
		'contact_number',
		array('name'=>'user_status','value'=>CHtml::encode($model->configStatus->setting_name)),
		array('name'=>'educational_level','value'=>CHtml::encode($model->configEducationalLevel->setting_name)),
		'graduated_school',
		'hometown',
		'hometown_address',
		'applied_position',
		...
		//'source',
		array('name'=>'source','value'=>$model->sourceName->name),
		'other',
		'create_user_id',
		'collect_time',
		'update_user_id',
